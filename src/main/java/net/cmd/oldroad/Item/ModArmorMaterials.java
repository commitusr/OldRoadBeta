...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ARTEFACT("artefact", 39, new int[]{3, 6, 8, 3}, 29, SoundEvents.ARMOR_EQUIP_GOLD, 5.0F, 1.0F, () -> {
        return Ingredient.of(ModItems.ARTEFACT.get());
    });
    ...
    public String getName() {
        return OldRoad.MOD_ID + ":" + this.name;
    }
